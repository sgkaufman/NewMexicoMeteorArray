...
"""
This is Version 2.0 of file ExternalScript.py. Dated 15-Jul-2022.
Byte count = 13871?
This script
...
def getFilesAndUpload(logger, nm_config, archived_night_dir, log_file_fd):
    ...
    # Get and print the contents of ~/RMS_data/US0002/NM_FILES_TO_UPLOAD.inf
    queue_file_name = os.path.expanduser('~/RMS_data/US0002/NM_FILES_TO_UPLOAD.inf')
...
def uploadFiles(captured_night_dir, archived_night_dir, config, \
    ...
    #data_dir: ~/RMS_data/US0001 

    # Variable definitions
    # next line commented out because I have substituted archived_night_dir in code below
    ...
    RMS_data_dir_name = os.path.expanduser(config.data_dir)
...
if __name__ == "__main__":
    ...
    config = RMS.ConfigReader.loadConfigFromDirectory(None, "~/source/Stations/US0002/.config")
