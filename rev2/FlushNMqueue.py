...
if __name__ == "__main__":
    ...
    config = RMS.ConfigReader.loadConfigFromDirectory('.', "/home/pi/source/RMS/")

    print("Running FlushNMqueue.py, 17-Jan, 2023, byte count 1414: flushing the NM upload queue...")
